...
async function loginAfp(page) {
    try {
        ...
        await page.type('[placeholder="Account"]', '151899', { delay: 300 });
        await page.type('[placeholder="Password"]', 'BACKOFFICEPC', { delay: 300 });
        await page.click('.el-button.login-btn-submit.el-button--primary.el-button--medium');
    } catch (error) {
...
async function logicalProgression() {
    ...
    await page.goto('https://dispatcher.redptt.com/login');
